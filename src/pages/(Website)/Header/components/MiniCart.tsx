        ...
        <div className="flex flex-col justify-between h-full">
            <div>
                <div className='text-center'>
                    <h3 className="font-bold mb-5 text-2xl pb-2 border-b-4 border-b-gray-400 inline-block">Giỏ Hàng</h3>
                </div>
            ...
            <div className="border-t border-t-gray-300 p-3">
                ...
                <div>
                    <button className='w-full bg-black text-white p-2 rounded-md mb-3 mt-5'>Xem Giỏ Hàng</button>
                    <button className='w-full hover:bg-gray-300 border border-collapse p-2 rounded-md'>Thanh Toán</button>
                </div>
            </div>
        </div>
    );
        ...
        <>
            <div className='items-center space-x-4'>
                <Badge count={1} className='relative'>
                    <ShoppingCartOutlined className='text-xl cursor-pointer' onClick={showDrawer} />
                </Badge>
            </div>
            <Drawer
                placement="right"
