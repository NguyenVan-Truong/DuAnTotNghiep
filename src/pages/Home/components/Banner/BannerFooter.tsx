                ...
                {activeIndex === 1 && (
                    <div className="flex flex-col xl:flex-row space-y-5 md:space-y-0 md:space-x-2">
                        <div className="flex-1 flex flex-col items-center mb-4">
                            ...
                            <Box maw={500} w="100%">
                                <Text size="sm" truncate="end">
                                    Không gian phòng khách nhỏ gọn nhưng vẫn đầy
                                    đủ tiện nghi, thoải mái và có tính thẩm mỹ
                                    cao nhờ những lựa chọn tinh tế về sản phẩm
                                    nội thất. Để tạo nên một không gian sống
                                    hoàn hảo, dù diện tích hạn chế, cần sự khéo
                                    léo để đảm bảo tính linh hoạt và thẩm mỹ,
                                    đồng thời phục vụ tốt nhất cho nhu cầu của
                                    gia chủ.
                                </Text>
                            </Box>
                        </div>
